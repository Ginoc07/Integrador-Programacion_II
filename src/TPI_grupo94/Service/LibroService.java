...
public class LibroService implements GenericService<Libro> {
    ...
    public void insertar(Libro libro) throws Exception {
        validateLibro(libro);
        validateIsbnUnique(libro.getFichaBibliografica().getIsbn(), null);
    ...
    public void actualizar(Libro libro) throws Exception {
        ...
        validateIsbnUnique(libro.getFichaBibliografica().getIsbn(), libro.getId());
     ...
     * @throws Exception Si hay error de BD
     */
    private void validateIsbnUnique(String isbn, Long libroId) throws Exception {
